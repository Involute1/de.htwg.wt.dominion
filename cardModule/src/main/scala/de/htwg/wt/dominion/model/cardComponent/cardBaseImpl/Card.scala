package de.htwg.wt.dominion.model.cardComponent.cardBaseImpl

import de.htwg.wt.dominion.model.cardComponent.cardBaseImpl
...
object Cardtype extends Enumeration {
  import play.api.libs.json._
  type Cardtype = Value
  val MONEY: Value = Value("Money")
  val VICTORYPOINT: Value = Value("VP")
  val KINGDOM: Value = Value("Kingdom")
