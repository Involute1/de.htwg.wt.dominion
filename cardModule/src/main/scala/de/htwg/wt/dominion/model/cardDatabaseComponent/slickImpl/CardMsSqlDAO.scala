package de.htwg.wt.dominion.model.cardDatabaseComponent.slickImpl

import java.util.concurrent.TimeUnit

import de.htwg.wt.dominion.model.cardComponent.cardBaseImpl.Cards
import de.htwg.wt.dominion.model.cardComponent.cardBaseImpl.{Card, Cards}
import de.htwg.wt.dominion.util.CardTables.{CardTable, DeckTable, HandCardsTable, PlayingCardsTable, StackerTable, TrashCardsTable}
